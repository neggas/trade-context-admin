...
export default function LiveTradesPage() {
  const { data: articles, isLoading } = useAdminArticles("live");
  ...
  return (
    <Box maxW="1250px" p="55px 35px 100px" m="auto">
      <Flex align="flex-end" justify="space-between" mb="45px">
        <Box>
          <Text variant="pageLabel">Content</Text>
          <Text variant="pageTitle" mt="10px">
            Live Trades
          </Text>
          <Text variant="pageDescription">
            Manage your real trading journal entries.
          </Text>
        </Box>
        <Link href="/live/new">
